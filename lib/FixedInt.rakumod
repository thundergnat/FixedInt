...
instance will be overwritten and dissapear.)
...
103, whatever. Once instantiated, it can be treated like any other varible. You
can add to it, subtract from it, multiply, divide, whatever; the value stored in
the varible will alway stay the specified bit size. Any excesses will "roll
over" the value. Works correctly for any standard bitwise or arithmatic
operator, though you must remember to assign to the varible to get the fixed
sized properties.
